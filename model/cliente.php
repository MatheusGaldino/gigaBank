...
class Cliente
{
	...
	public function cadastrarCliente(){
		...
		if($db->query("INSERT INTO cliente (nome, cpf, email, telefone, celular, cep, endereco, numeroCasa, bairro, cidade, uf, dataCadastro, dataNasc) values ('{$this->nome}', '{$this->cpf}', '{$this->email}', '{$this->telefone}', '{$this->celular}', '{$this->cep}', '{$this->endereco}', '{$this->numeroCasa}', '{$this->bairro}', '{$this->cidade}', '{$this->uf}', '{$this->dataCadastro}', '{$this->dataNasc}')")){
